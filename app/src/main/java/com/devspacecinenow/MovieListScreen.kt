...
fun MovieListScreen(navController: NavHostController) {
    ...
    callNowPlaying.enqueue(object : retrofit2.Callback<MovieResponse> {
    ...
    callTopRated.enqueue(object : retrofit2.Callback<MovieResponse>{
        override fun onResponse(
            call: Call<MovieResponse>,
            response: Response<MovieResponse>
        ) {
    ...
    callPopular.enqueue(object : retrofit2.Callback<MovieResponse>{
        override fun onResponse(
            call: Call<MovieResponse>,
            response: Response<MovieResponse>
        ) {
    ...
    callUpcoming.enqueue(object : retrofit2.Callback<MovieResponse>{
        override fun onResponse(
            call: Call<MovieResponse>,
            response: Response<MovieResponse>
        ) {
